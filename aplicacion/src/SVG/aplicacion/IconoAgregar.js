...
<svg width="20px" height="20px" viewBox="0 0 42 42" {...props}>
<title/>
<path fill="fill" d="M37.059,16H26V4.941C26,2.224,23.718,0,21,0s-5,2.224-5,4.941V16H4.941C2.224,16,0,18.282,0,21
